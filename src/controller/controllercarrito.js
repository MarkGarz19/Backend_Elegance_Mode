                ...
                if (metodoDePago === 'paypal') {
                    ...
                    request.requestBody({
                        ...
                        application_context: {
                            ...
                            return_url: 'https://frontend-elegance-mode.onrender.com/frontend/src/index.html',
                            cancel_url: 'https://frontend-elegance-mode.onrender.com/frontend/src/index.html'
                        }
                    });
